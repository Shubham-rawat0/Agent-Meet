  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] px-6 text-center">
      ...
      <p className="mt-4 text-gray-600 max-w-xl text-base md:text-lg">
        Agentmeet is an AI-powered platform that lets you schedule and interact
        with intelligent agents as if you're in a real meeting. Get instant
        insights, automate conversations, and boost productivity.
      </p>
